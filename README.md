...
```javascript
iterHead = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-head@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/iter-head@v0.2.3-umd/browser.js"></script>
```
